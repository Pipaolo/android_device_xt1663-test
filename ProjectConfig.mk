...
# lenovo-sw liaohj modify for 6630 N
...
CUSTOM_HAL_IMGSENSOR = s5k3p3sx_mipi_raw imx219_mipi_raw hi843b_mipi_raw
CUSTOM_HAL_LENS = dw9800sunnyaf dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = dummy_lens
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3p3sx_mipi_raw
CUSTOM_HAL_MAIN_LENS = dw9800sunnyaf 
...
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR = hi843b_mipi_raw
CUSTOM_HAL_SUB_BACKUP_LENS = dummy_lens
CUSTOM_HAL_SUB_IMGSENSOR = imx219_mipi_raw 
...
CUSTOM_KERNEL_CAM_CAL = s5k3m2_otp dummy_eeprom
...
CUSTOM_KERNEL_IMGSENSOR = s5k3p3sx_mipi_raw imx219_mipi_raw hi843b_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9800sunnyaf dummy_lens
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3p3sx_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = dw9800sunnyaf
...
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR = hi843b_mipi_raw
CUSTOM_KERNEL_SUB_BACKUP_LENS = dummy_lens
CUSTOM_KERNEL_SUB_IMGSENSOR = imx219_mipi_raw 
...
#linyf modify
#CUSTOM_MODEM = kungfu_m_lwctg_mp3 kungfu_m_c2k
CUSTOM_MODEM = kungfu_lwctg_md1 
#linyf end
...
MTK_AGPS_APP = yes
MTK_AIV_SUPPORT = no
#BEGIN Lenovo, wangsq2, 2016-12-07, KUNGFU-532
...
# lenovo-sw zhaochuang2 modify for N
MTK_ALPS_GATEWAY_SUPPORT = no
# begin, lenovo xucw 20161129 for KUNGFUN-431
#MTK_ANDROID_FOR_WORK_SUPPORT = yes
MTK_ANDROID_FOR_WORK_SUPPORT = no
# end, lenovo xucw 20161129
MTK_ANT_SUPPORT = no
MTK_AOD_SUPPORT = no
MTK_API_CHECK = yes
...
MTK_AUDIO_SPEAKER_PATH = smartpa_nxp_tfa9890
...
MTK_BIP_SCWS = yes
# lenovo-sw wuwl10 modify for PQ
...
MTK_BUILD_VERNO = alps-mp-n0.mp7-V1_lenovo6755.66.n_P146
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 0
...
# lenovo_sw liaohj modify for 6630 N
# lenovo-sw zhaochuang2 modify for N
...
# lenovo-sw wuwl10 20160922 modify for lcm,not use any more
...
# BEGIN Lenovo lubm1 20170420 KFNROW-292  Enable dynamic IMS switch.
...
MTK_FIRST_MD = 1
#BEGIN Lenovo, linyf, 2015-11-12, KOLEOSII-433, config for K52_e78.
...
#begin,lenovo-sw liyuan8 20161010
MTK_HOTKNOT_SUPPORT = no
#end,lenovo-sw liyuan8 20161010
...
# lenovo-sw wuwl10 20160922 modify for lcm
MTK_IRTX_SUPPORT = no
...
# lenovo-sw wuwl10 20160922 modify ,not use any more
...
# lenovo-sw wuwl10 20160922 modify for PQ
...
#BEGIN Lenovo, linyf, 2015-11-12, KOLEOSIIM-273, config for K52_e78.
...
#BEGIN Lenovo, linyf, 2016-03-28, KOLEOSII-433, config for K52_e78.
...
MTK_SMSREG_APP = no
MTK_SMT_SUPPORT = no
#BEGIN Lenovo, zengzm, 2016-11-29,for wechat pay
MTK_SOTER_SUPPORT = yes
#END Lenovo, zengzm, 2016-11-29,for wechat pay
...
#Lenovo-sw sunliang2 add for lshutter begin
LENOVO_LSHUTTER_SWITCH = yes
#Lenovo-sw sunliang2 add for lshutter end
#lenovo-sw ZHANGJIANO add manual shutter Begin
LENOVO_CAMERA_MANUAL_SHUTTER = yes
#lenovo-sw ZHANGJIANO add manual shutter end
#lenovo.sw wuyt3 add for flawless
LENOVO_FLAWLESS_SUPPORTED = yes
#end
...
#lenovo-sw chengx2 add for audio factory test start
LENOVO_KUNGFU_AUDIO_FT_SUPPORT = yes
#lenovo-sw chengx2 add for audio factory test end
#CREATE_PROJECT_INFO=20160905183331
######## Lenovo BSP Feature begin ######################################################
######### LCD ######################################
#lenovo-sw wuwl10 20160406 add for multi gamma begin
LENOVO_PQ_MULTI = yes
LENOVO_PANELMODE_SUPPORT = yes
DISPLAY_PANEL_POWER_MODE_FOR_VIDEO = yes
#lenovo-sw wuwl10 20160406 add for multi gamma end
# lenovo-sw wuwl9 2016.3.22 add for recovery begain
###Lenovo-ROW, miaotao1, DO NOT USE LENOVO RECOVERY
###LENOVO_RECOVERY_SUPPORT = yes
LENOVO_RECOVERY_SUPPORT = no
# lenovo-sw wuwl9 2016.3.22 add for recovery end
#lenovo-sw mahj2 add for power off charging ui Begin
MOTO_POWEROFF_CHARGING_UI = yes
#lenovo-sw mahj2 add for power off charging ui End

#Lenovo-sw weimh1 add 2016-9-30 begin
LENOVO_PRODUCT_KUNGFUM = yes
CUSTOM_KERNEL_STEP_COUNTER = bmi160
CUSTOM_KERNEL_SIGNIFICANT_MOTION_SENSOR = 
#Lenovo-sw weimh1 add 2016-9-30 end
######## Lenovo BSP Feature end ######################################################
